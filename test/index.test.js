...
describe("written-number2", function () {
    describe("writtenNumber exceptions)", function () {
        it("throw an error if user didn't pass a language", function () {
            (() => new WrittenNumber()).should.throw('WrittenNumber: you need to pass your language object')
        });

        it("throw an error if user didn't pass new options for setOptions", function () {
    ...
    describe("writtenNumber: 'En' language", function () {
        const Converter = new WrittenNumber({language: En});
    ...
    describe("writtenNumber: 'Es' language", function () {
    ...
    describe("writtenNumber: 'Pt' language", function () {
    ...
    describe("writtenNumber: 'ptPT' language", function () {
    ...
    describe("writtenNumber: 'Fr' language", function () {
    ...
    describe("writtenNumber: 'It' language", function () {
    ...
    describe("writtenNumber: 'EnIndian' language", function () {
    ...
    describe("writtenNumber: 'Tr' language", function () {
    ...
    describe("writtenNumber: 'Az' language", function () {
    ...
    describe("writtenNumber: 'Uk' language", function () {
    ...
    describe("writtenNumber: 'Ar' language", function () {
    ...
    describe("writtenNumber: 'Id' language", function () {
    ...
    describe("writtenNumber: 'Ru' language", function () {
