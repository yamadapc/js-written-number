...
var languages = ['en', 'es', 'pt', 'fr', 'eo', 'vi'];
var i18n = {
...
function writtenNumber(n, options) {
  options = options || {};
  var language = writtenNumber.defaults.lang;

  if (typeof options.lang === 'object') {
    language = (options.lang && Object.keys(options.lang).length > 0) ? options.lang : null;
  } else {
    if(options.lang) options.lang = options.lang.toLowerCase();
    options = util.defaults(options, writtenNumber.defaults);
    language = i18n[options.lang];
  }
