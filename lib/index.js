...
export class WrittenNumber {
  ...
  convert = (number, options = this.options) => {
    ...
    if (n < 100)
      return this.__handleSmallerThan100({number, language, baseCardinals, alternativeBaseCardinals});
  ...
  __handleSmallerThan100 = ({number, language, baseCardinals, alternativeBaseCardinals}) => {
